...
function Modal({
  ...
  const maxW =
    size === "sm" ? "560px" :
    size === "md" ? "720px" :
    size === "xl" ? "1120px" : "960px";

  return (
    <div className="modal-overlay" onMouseDown={onClose}>
      <div className="modal-center" onMouseDown={(e) => e.stopPropagation()}>
        <div className="modal-card" style={{ maxWidth: maxW }} role="dialog" aria-modal="true">
          {title && (
  ...
  return createPortal(
    <>
      ...
      <div
        style={{ position: "fixed", zIndex: 1001, left: "50%", top: "50%", transform: "translate(-50%, -50%)", width: "1100px", maxWidth: "96vw", maxHeight: "88vh" }}
        role="dialog" aria-modal="true"
      >
        <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", boxShadow: "0 24px 60px rgba(15,23,42,.28)", padding: 20, overflow: "auto", maxHeight: "88vh" }}>
          {children}
        </div>
      </div>
    </>,
